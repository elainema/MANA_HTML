...
gulp.task('extend-MANA', function () {
    gulp.src('../mana/html/**/*.html')
        .pipe(gulp.dest('../MANA_HTML/html'))

})

gulp.task('copy', ['extend-MANA'], function () {
    gulp.watch(['../mana/html/**/*.html'], ['extend-MANA'])
})
